...
export const RENDER_TUNING = Object.freeze({ fastTrails: false, atmosphere: true, simpleShadows: false, cachedGlows: false, crowdShadows: true, enemyHealthBars: 'all', terrainMacro: 1, fastCrowdSprites: false, animatedSheets: true });
