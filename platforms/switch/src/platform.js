...
export const RENDER_TUNING = Object.freeze({ fastTrails: true, atmosphere: false, simpleShadows: true, cachedGlows: true, crowdShadows: false, enemyHealthBars: 'damaged', terrainMacro: 2, cacheProjectileMotion: true });
